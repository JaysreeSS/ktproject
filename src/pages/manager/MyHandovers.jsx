            ...
            <main className="px-8 md:px-12 py-6 max-w-7xl mx-auto space-y-5 animate-in fade-in duration-700">
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-10">
                    <div className="space-y-1">
                        ...
                        <p className="text-slate-500 font-bold text-sm leading-relaxed max-w-lg">Manage sections assigned to you for contribution.</p>
                    </div>
                                ...
                                <div className="flex items-center justify-center gap-2 pt-4">
                                    ...
                                    {[...Array(totalPages)].map((_, i) => (
                                        <Button
                                            ...
                                            className={`rounded-lg h-9 w-9 p-0 font-black text-xs ${currentPage === i + 1 ? 'shadow-lg shadow-primary/20 bg-primary text-white border-primary' : 'border-slate-200 text-slate-500 hover:bg-slate-50'
                                                }`}
                                        >
                                            {i + 1}
                                        </Button>
